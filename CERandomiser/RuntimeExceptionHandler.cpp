...
void RuntimeExceptionHandler::handleMessage(CEERExceptionBase& ex, std::vector<Option<bool>*> optionsToDisable)
{
	// Log to console
...
void RuntimeExceptionHandler::handleSilent(CEERExceptionBase& ex, std::vector<Option<bool>*> optionsToDisable)
{
	// Log to console
	PLOG_ERROR << "EXCEPTION: " << std::string(ex.what()) << std::endl << std::string(ex.source()) << std::endl << std::string(ex.trace());
...
void RuntimeExceptionHandler::handlePopup(CEERExceptionBase& ex, std::vector<Option<bool>*> optionsToDisable)
{
	// Log to console
	PLOG_ERROR << "EXCEPTION: " << std::string(ex.what()) << std::endl << std::string(ex.source()) << std::endl << std::string(ex.trace());
