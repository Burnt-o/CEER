...
//	{
//		mh_Hook_SpawnActvByIndex->setWantsToBeAttached(value);
//		mh_Hook_EvaluateEncounter->setWantsToBeAttached(value);
...
//
////hooks objects
//ModuleMidHook* mh_Hook_SpawnActvByIndex = new ModuleMidHook(L"Hook_SpawnActvByIndex", p_Hook_SpawnActvByIndex, Hook_SpawnActvByIndex, false);
//ModuleMidHook* mh_Hook_EvaluateEncounter = new ModuleMidHook(L"Hook_EvaluateEncounter", p_Hook_EvaluateEncounter, Hook_EvaluateEncounter, false);
//
//
////hook functions
