...
constexpr std::array targetProcessNames { "MCC-Win64-Shipping", "MCCWinStore-Win64-Shipping" };
constexpr auto dllName = "CERandomiser";
...
int main()
{
	...
	//TODO : instead of checking windows admin perm, we'll check for the specific ones we need for createRemoteThread/WriteProcessMemory
	// PROCESS_CREATE_THREAD && PROCESS_QUERY_INFORMATION && PROCESS_VM_OPERATION && PROCESS_VM_WRITE && PROCESS_VM_READ
	// though according to what I'm reading, apparently injectors only need admin perms if target process is admin too.
	// So we should just try inject and report failure.
